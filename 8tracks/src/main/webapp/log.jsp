  ...
  <body onLoad="javascript:document.logFilterForm.logNameFilter.focus();">
    ...
    <div id="content">
      ...
      <div class="filterForm">
        <form action="log.jsp" name="logFilterForm">Filter Loggers:&nbsp;&nbsp;
      ...
      <table cellspacing="1">
        ...
        <tr>
          ...
          <%
            ...
            {
              String url = "log.jsp?operation=changeLogLevel&logger=" + loggerName + "&newLogLevel=" + logLevels[cnt] + "&logNameFilter=" + (logNameFilter != null ? logNameFilter : "");
